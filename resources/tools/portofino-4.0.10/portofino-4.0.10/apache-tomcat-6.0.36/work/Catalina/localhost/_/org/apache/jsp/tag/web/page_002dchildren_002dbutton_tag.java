...
public final class page_002dchildren_002dbutton_tag
 ...
 if(SecurityLogic.hasPermissions(actionBean.getPageInstance(), SecurityUtils.getSubject(), AccessLevel.EDIT)) { 
      out.write("\n");
      out.write("<button name=\"pageChildren\"\n");
      out.write("        type=\"submit\"\n");
      out.write("        class=\"folder-open ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only\"\n");
      out.write("        role=\"button\" aria-disabled=\"false\"\n");
      out.write("        title=\"Page children\">\n");
      out.write("    <span class=\"ui-button-icon-primary ui-icon ui-icon-folder-open\"></span>\n");
      out.write("    <span class=\"ui-button-text\">Page children</span>\n");
      out.write("</button>\n");
 } 
    } catch( Throwable t ) {
