...
public final class page_002dcopy_002dbutton_tag
 ...
 if(SecurityLogic.hasPermissions(actionBean.getPageInstance(), SecurityUtils.getSubject(), AccessLevel.EDIT)) { 
      out.write("\n");
      out.write("<button onclick=\"showCopyPageDialog(\n");
      out.write("                    '");
      ...
      out.write("        class=\"copy ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only\"\n");
      out.write("        role=\"button\" aria-disabled=\"false\"\n");
      out.write("        title=\"Copy page\">\n");
      out.write("    <span class=\"ui-button-icon-primary ui-icon ui-icon-copy\"></span>\n");
      out.write("    <span class=\"ui-button-text\">Copy page</span>\n");
      out.write("</button>\n");
 } 
    } catch( Throwable t ) {
