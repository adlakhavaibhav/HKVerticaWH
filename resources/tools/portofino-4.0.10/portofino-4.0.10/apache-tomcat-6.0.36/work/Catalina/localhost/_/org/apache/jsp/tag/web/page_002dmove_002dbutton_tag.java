...
public final class page_002dmove_002dbutton_tag
 ...
 if(SecurityLogic.hasPermissions(actionBean.getPageInstance(), SecurityUtils.getSubject(), AccessLevel.EDIT)) { 
      out.write("\n");
      out.write("<button onclick=\"showMovePageDialog(\n");
      out.write("                    '");
      ...
      out.write("        class=\"transferthick-e-w ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only\"\n");
      out.write("        role=\"button\" aria-disabled=\"false\"\n");
      out.write("        title=\"Move page\">\n");
      out.write("    <span class=\"ui-button-icon-primary ui-icon ui-icon-transferthick-e-w\"></span>\n");
      out.write("    <span class=\"ui-button-text\">Move page</span>\n");
      out.write("</button>\n");
 } 
    } catch( Throwable t ) {
