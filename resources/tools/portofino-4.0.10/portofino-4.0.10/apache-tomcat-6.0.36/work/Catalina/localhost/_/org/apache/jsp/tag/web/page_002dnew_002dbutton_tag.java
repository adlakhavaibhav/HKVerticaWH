...
public final class page_002dnew_002dbutton_tag
 ...
 if(SecurityLogic.hasPermissions(actionBean.getPageInstance(), SecurityUtils.getSubject(), AccessLevel.EDIT)) { 
      out.write("\n");
      out.write("<button name=\"newPage\"\n");
      out.write("        type=\"submit\"\n");
      out.write("        class=\"plusthick ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only\"\n");
      out.write("        role=\"button\" aria-disabled=\"false\"\n");
      out.write("        title=\"Add page\">\n");
      out.write("    <span class=\"ui-button-icon-primary ui-icon ui-icon-plusthick\"></span>\n");
      out.write("    <span class=\"ui-button-text\">Add page</span>\n");
      out.write("</button>\n");
 } 
    } catch( Throwable t ) {
