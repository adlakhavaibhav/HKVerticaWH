...
public final class page_002dpermissions_002dbutton_tag
 ...
 if(SecurityLogic.hasPermissions(actionBean.getPageInstance(), SecurityUtils.getSubject(), AccessLevel.DEVELOP)) { 
      out.write("\n");
      out.write("<button name=\"pagePermissions\"\n");
      out.write("        type=\"submit\"\n");
      out.write("        class=\"person ui-button ui-widget ui-state-default ui-corner-all ui-button-icon-only\"\n");
      out.write("        role=\"button\" aria-disabled=\"false\"\n");
      out.write("        title=\"Page permissions\">\n");
      out.write("    <span class=\"ui-button-icon-primary ui-icon ui-icon-person\"></span>\n");
      out.write("    <span class=\"ui-button-text\">Page permissions</span>\n");
      out.write("</button>\n");
 } 
    } catch( Throwable t ) {
